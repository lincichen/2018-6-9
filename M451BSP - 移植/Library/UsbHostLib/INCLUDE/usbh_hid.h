...
/** @addtogroup USBH_HID_Driver USB Host HID Driver
  @{
*/
...
/** @addtogroup USBH_HID_EXPORTED_CONSTANTS USB Host HID Driver Exported Constants
  @{
*/
...
/*@}*/ /* end of group USBH_HID_EXPORTED_CONSTANTS */


struct usbhid_dev;               /*!< HID device structure  \hideinitializer             */


/** @addtogroup USBH_HID_EXPORTED_TYPEDEFS USB Host HID Driver Exported Type Define
  @{
 */
...
/*@}*/ /* end of group USBH_HID_EXPORTED_TYPEDEFS */


/** @addtogroup USBH_HID_EXPORTED_STRUCTURES USB Host HID Driver Exported Structures
  @{
*/
...
/*@}*/ /* end of group USBH_HID_EXPORTED_STRUCTURES */
...
/** @addtogroup USBH_HID_EXPORTED_FUNCTIONS USB Host HID Driver Exported Functions
  @{
 */
...
/*@}*/ /* end of group USBH_HID_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group USBH_HID_Driver */
