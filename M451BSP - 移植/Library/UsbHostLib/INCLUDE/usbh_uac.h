...
/** @addtogroup USBH_AS_Driver USB Host Audio Class Driver
  @{
*/

/** @addtogroup USBH_AS_EXPORTED_CONSTANTS USB Host Audio Class Driver Exported Constants
  @{
*/
...
/*@}*/ /* end of group USBH_AS_EXPORTED_CONSTANTS */

struct uac_dev_t;


/** @addtogroup USBH_AS_EXPORTED_TYPEDEFS USB Host Audio Class Driver Exported Type Define
  @{
*/
...
/*@}*/ /* end of group USBH_AS_EXPORTED_TYPEDEFS */


/** @addtogroup USBH_AS_EXPORTED_STRUCTURES USB Host Audio Class Driver Exported Structures
  @{
*/
...
/*@}*/ /* end of group USBH_AS_EXPORTED_STRUCTURES */
...
/** @addtogroup USBH_AS_EXPORTED_FUNCTIONS USB Host Audio Class Driver Exported Functions
  @{
*/
...
/*@}*/ /* end of group USBH_AS_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group USBH_AS_Driver */
