...
#line 159 "..\\..\\..\\..\\Library\\CMSIS\\Include\\core_cm4.h"



#line 1752 "..\\..\\..\\..\\Library\\CMSIS\\Include\\core_cm4.h"
...
void TMR0_IRQHandler(void)
{
    ...
    TIMER_ClearIntFlag(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x10000)));
...
void Timer0_Init(void)
{
    ...
    TIMER_Open(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x10000)), (1UL << (27)), 11);

    
    TIMER_EnableInt(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x10000)));
    NVIC_EnableIRQ(TMR0_IRQn);

    
    TIMER_Start(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x10000)));    
}
...
int32_t main (void)
{
    ...
    cbs = (au32Config[0] >> 6) & 0x3;
			...
			for(;;)
			{
				...
				printf("\n请选择功能\n1：接收文件（test.txt）\n2: 发送文件\n");
				UART_Read(((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000)),&Qhuan,1);
				if(Qhuan == '1'||Qhuan == '2')
					break;
			}
			if(Qhuan == '1')
...
int  load_image_to_flash(uint32_t image_base, uint32_t image_limit, uint32_t flash_addr, uint32_t max_size)
{
    ...
    for (i = 0; i < u32ImageSize; i += 0x800) {
