...
{
    if(i32BootSrc)
        ((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL |= (0x1ul << (1));  
    else
        ((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL &= ~(0x1ul << (1)); 
}
...
void FMC_Close(void)
{
    ((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL &= ~(0x1ul << (0));
}
...
void FMC_DisableAPUpdate(void)
{
    ((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL &= ~(0x1ul << (3));
}
...
void FMC_DisableConfigUpdate(void)
{
    ((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL &= ~(0x1ul << (4));
}
...
void FMC_DisableLDUpdate(void)
{
    ((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL &= ~(0x1ul << (5));
}
...
int32_t FMC_GetBootSource(void)
{
    if(((FMC_T *) ((0x40000000UL) + 0x0C000))->ISPCTL & (0x1ul << (1)))
        return 1;
    else
        return 0;
}
...
uint32_t FMC_ReadDataFlashBaseAddr(void)
{
    return ((FMC_T *) ((0x40000000UL) + 0x0C000))->DFBA;
}
...
void FMC_EnableFreqOptimizeMode(uint32_t u32Mode)
{
    ((FMC_T *) ((0x40000000UL) + 0x0C000))->FTCTL &= ~(0x7ul << (4));
    ((FMC_T *) ((0x40000000UL) + 0x0C000))->FTCTL |= (u32Mode << (4));
}
